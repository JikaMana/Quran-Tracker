    ...
    <div className="flex flex-col justify-between h-screen w-full bg-gradient-to-b from-green-50 to-white">
      <div className="flex flex-col justify-center items-center mt-28">
        ...
        <div className="flex gap-4">
          <button className="text-lg bg-green-700 py-2 px-4 rounded-md text-white">
            Start Tracking progress
          </button>
          <button className="text-lg bg-transparent border-2 border-amber py-2 px-4 rounded-md text-amber">
